...
const FeatureSection = () => {
  return (
    <>
      ...
      <div id="feature" className="bg-gray-900 ">
        <div className="max-w-[1560px] mx-auto py-20 px-40 sm:px-4 sm:py-32 lg:px-8 xl:px-28 2xl:px-40 hidden sm:block">
                  ...
                  <div class="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                    <div class="relative z-10 p-8">
                      ...
                      <p class="mt-2 text-sm text-gray-400">
                        ...
                        that’s going to lower the share price on your holdings
                        so you can sell before the information hits the public
                        markets.
                      </p>
                    </div>
                  </div>
      ...
      <div
        id="mFeature"
        className="feature-section-main-for-mobile bg-gray-900 font-Inter text-left px-6 py-20 block sm:hidden"
      >
        <h2 class="text-3xl font-medium tracking-tight text-white leading-[40px]">
          Every feature you need to win. Try it for yourself.
        </h2>
        <p class="mt-2 text-lg text-gray-400 leading-[30px]">
        ...
        <div className="slider-section mt-10 ">
          <Swiper pagination={true} modules={[Pagination]} className="mySwiper">
            <SwiperSlide>
              <div className="slider-body bg-gray-700 rounded-2xl">
                {/* image part */}
                <div className="slider-image px-6">
                  <img
                ...
                {/* card details part */}
                <div className="card-details font-Inter">
                  <div class=" bg-gray-800 backdrop-blur pt-6 p-4 rounded-b-2xl pb-6">
