        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-2 text-lg text-gray-600">
              ...
              <a class="text-gray-900 underline" href="mailto:info@example.com">
                reach out to us
              </a>
              .
            </p>
              ...
              <ul role="list" class="space-y-10">
                ...
                <li>
                  ...
                  <p class="mt-4 text-sm text-gray-700">
                    ...
                    insider trades with knowledge from your direct network.
                    Pocket brings you insider trading tips from people you don’t
                    even know.
                  </p>
                </li>
                <li>
                  ...
                  <p class="mt-4 text-sm text-gray-700">
                    ...
                    not us. We’re just giving you the tips and some tools to
                    make trades. We’re not doing anything wrong here.
                  </p>
                </li>
              </ul>
            </li>
              ...
              <ul role="list" class="space-y-10">
                ...
                <li>
                  ...
                  <p class="mt-4 text-sm text-gray-700">
                    ...
                    advanced transaction anonymization though, so you can use
              ...
              <ul role="list" class="space-y-10">
                ...
                <li>
                  ...
                  <p class="mt-4 text-sm text-gray-700">
                    ...
                    Once approved, we’ll send you a guide on collecting insider
